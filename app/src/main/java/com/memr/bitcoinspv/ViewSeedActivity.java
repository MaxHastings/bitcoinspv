...
public class ViewSeedActivity extends WalletAppKitActivity {
    ...
    protected void onWalletKitReady() {
        setContentView(com.memr.bitcoinspv.R.layout.activity_view_seed);

        seedText = findViewById(com.memr.bitcoinspv.R.id.seedTextView);
        timeCreated = findViewById(com.memr.bitcoinspv.R.id.timeCreated);
        decryptingLayout = findViewById(com.memr.bitcoinspv.R.id.decryptingLayout);
        seedLayout = findViewById(com.memr.bitcoinspv.R.id.seedViewLayout);
        ...
        seedText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ViewSeedActivity.this, com.memr.bitcoinspv.R.string.seed_copied, Toast.LENGTH_LONG).show();
            }
        });
        ...
        timeCreated.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ViewSeedActivity.this, com.memr.bitcoinspv.R.string.time_created_copied, Toast.LENGTH_LONG).show();
            }
        });
    }
